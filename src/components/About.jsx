          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-blue-900 to-blue-700 text-white rounded-lg p-8 shadow-xl">
              ...
              <p className="text-white/90">
                Certified lawyers and consultants with expertise in immigration law across three major jurisdictions.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-yellow-400 to-blue-600 text-white rounded-lg p-8 shadow-xl">
              ...
              <p className="text-white/90">
                Strategic offices in Toronto, London, and New York for comprehensive international coverage.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-800 to-blue-800 text-white rounded-lg p-8 shadow-xl">
              ...
              <p className="text-white/90">
                Canada offers over 60 different immigration programs. We help you choose the right one for your situation.
              </p>
            </div>
          </div>
        </div>
